...
% Identificador técnico en monoespaciado: \id{ms-pedidos}
...
\newcommand{\faltafig}[1]{%
  \fbox{\parbox{0.92\linewidth}{\centering\small
    ...
    Exporta el diagrama y déjalo en \texttt{figuras/} con ese nombre.}}}
...
% girar solo gana escala si el diagrama es más ancho que alto. Un diagrama
% más alto que ancho no gana nada girado, así que la respuesta habitual es
% «vertical».
%
